    ...
    public class CartServiceTests
    {
        ...
        public void Initialize()
        {
            _Cart = new Cart
            {
                ...
                {
                    new(){ ProductId = 1, Quentity = 1},
                    new(){ ProductId = 2, Quentity = 3},
                }
            };
        ...
        public void Cart_Class_ItemsCount_returns_Correct_Quantity()
        {
            ...
            var expected_items_count = _Cart.Items.Sum(i => i.Quentity);

            var actual_items_count = cart.ItemCount;
        ...
        public void CartViewModel_Returns_Correct_TotalPrice()
        {
            ...
            var expected_total_price = cart_view_model.Items.Sum(
                item => item.Quentity * item.Product.Price
            );
        ...
        public void CartService_Add_WorkCorrect()
        {
            ...
            Assert.Equal(expected_items_count, _Cart.ItemCount);
        ...
        public void CartService_Decrement_Correct()
        {
            ...
            Assert.Equal(expectes_items_count, _Cart.ItemCount);
            ...
            Assert.Equal(expected_quantity, items[1].Quentity);
        }
