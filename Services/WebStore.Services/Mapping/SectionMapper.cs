...
namespace WebStore.Services.Mapping
{
    public static class SectionMapper
    {
        ...
        public static IEnumerable<SectionDTO> ToDTO(this IEnumerable<Section> products) =>
            products.Select(ToDTO);

        public static IEnumerable<Section> FromDTO(this IEnumerable<SectionDTO> products) =>
